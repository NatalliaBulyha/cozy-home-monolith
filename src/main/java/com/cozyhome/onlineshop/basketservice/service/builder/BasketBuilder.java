...
public class BasketBuilder {	
	...
	public List<BasketDto> buildBasketDtoList(List<BasketItem> basketItemlist, List<FavoriteItem> favoriteItems){
		...
		for(BasketItem basketItem : basketItemlist) {
			...
			boolean isFavorite = favoriteItems.stream().anyMatch(item -> item.getProductColor().equals(basketItem.getProductColor()));
			if(isFavorite) {
